...
> = {
  "zh-CN": {
    ...
    visitorRecord: {
      ...
      intakeDescription:
        "把 intake 聚焦在时间压力、资金、临时居留意图和支持材料上，让后续审查始终围绕真实案件展开。",
    ...
    studyPermitExtension: {
      ...
      intakeDescription: "把 intake 聚焦在到期压力、在读证明、资金情况和学业进展上，让审查真正反映延期资料包。",
  ...
  "zh-TW": {
    ...
    visitorRecord: {
      ...
      intakeDescription:
        "把 intake 聚焦在時間壓力、資金、臨時居留意圖和支持材料上，讓後續審查始終圍繞真實案件展開。",
    ...
    studyPermitExtension: {
      ...
      intakeDescription: "把 intake 聚焦在到期壓力、在讀證明、資金情況和學業進展上，讓審查真正反映延期資料包。",
