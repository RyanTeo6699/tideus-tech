    ...
    locale === "zh-TW"
      ? {
          ...
          sections: [
            ...
            {
              title: "案件工作台資料",
              body: "目前產品會保存案件紀錄、 intake 回覆、材料狀態追蹤、審查輸出、工作流程狀態歷史與審查版本，讓使用者不必重頭開始。"
            },
            {
              title: "上傳材料",
            ...
            {
              title: "工作流程歷史",
              body: "Tideus 也會保存結構化案件事件，例如案件建立、 intake 完成、材料更新、審查生成與案件恢復。目標是產品連續性與未來工作流程分析，而不是在本階段建立面向使用者的分析儀表板。"
            },
            {
              title: "示範與早期存取請求",
      ...
      : {
          ...
          sections: [
            ...
            {
              title: "案件工作台数据",
              body: "当前产品会保存案件记录、 intake 回答、材料状态跟踪、审查输出、工作流状态历史与审查版本，让用户不必从头开始。"
            },
            {
              title: "上传材料",
            ...
            {
              title: "工作流历史",
              body: "Tideus 也会保存结构化案件事件，例如案件创建、 intake 完成、材料更新、审查生成与案件恢复。目标是产品连续性与未来工作流分析，而不是在本阶段建立面向用户的分析仪表盘。"
            },
            {
              title: "演示与早期访问请求",
