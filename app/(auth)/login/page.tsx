    ...
    <div className="grid w-full gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
      <div className="max-w-xl">
        <Badge variant="inverse" className="mb-6">
          {messages.authPage.loginBadge}
        </Badge>
        <h1 className="font-serif text-5xl leading-tight">{messages.authPage.loginTitle}</h1>
        <p className="mt-6 text-lg leading-8 text-slate-300">{messages.authPage.loginDescription}</p>
        <div className="mt-10 space-y-3">
          {messages.authPage.loginHighlights.map((item) => (
